...
--CREATE TABLE seat_hold(hold_id INT PRIMARY KEY, user_id INT,hold_date TIMESTAMP)
--
--CREATE TABLE booking(booking_id INT PRIMARY KEY, user_id INT ,booking_date TIMESTAMP)
--CREATE TABLE holding_seat_map(hold_seat_map_id INT PRIMARY KEY,hold_id INT ,seat_id INT )
--CREATE TABLE booking_seat_map(booking_seat_map_id INT PRIMARY KEY,booking_id INT ,seat_id INT )
--CREATE TABLE SEATS(seat_id INT PRIMARY KEY,level_id INT , row_id INT, seat_num INT)
--CREATE TABLE AUDITORIUM_METADATA(level_id INT PRIMARY KEY,level_name varchar(50),price DOUBLE, total_rows INT, SEATS_IN_ROW INT)
